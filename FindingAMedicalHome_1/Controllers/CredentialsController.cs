...
using FindingAMedicalHome_1.Models;
...
namespace FindingAMedicalHome_1.Controllers
{
    public class CredentialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Password")] Credentials credentials)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Password")] Credentials credentials)
        {
            if (ModelState.IsValid)
            {
